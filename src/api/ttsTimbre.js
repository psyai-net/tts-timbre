...
async function getListCollect(form) {
  return checkResult(
    await axios.get(
      psyaiEditorUrl + "inner/joint/assets/tts/timbre/collect/list" + form,
      {
        headers: {
          "Content-Type": "application/json",
          token: psyaiEditorToken,
...
async function setCollection(form, obj) {
  return checkResult(
    await axios.post(
      psyaiEditorUrl + "inner/joint/assets/tts/timbre/collect" + form,
      {
        ...obj,
      },
      {
...
async function delCollection(form, obj) {
  return checkResult(
    await axios.post(
      psyaiEditorUrl + "inner/joint/assets/tts/timbre/collect/cancel" + form,
      {
        ...obj,
      },
      {
...
async function aditionCreate(form) {
  return checkResult(
    await axios.post(
      psyaiEditorUrl + "web-tools/tts/gen",
      {
        ...form,
      },
      {
...
async function querySpeakerInfo(speaker_id) {
  return checkResult(
    await axios.post(
      `${psyaiEditorUrl}inner/joint/assets/tts/timbre/info`,
      {
        speaker_id,
      },
      {
...
async function voiceEditorData() {
  return checkResult(
    await axios.post(
      psyaiEditorUrl + "web-tools/tts/label",
      {},
      {
        headers: {
          "Content-Type": "application/json",
